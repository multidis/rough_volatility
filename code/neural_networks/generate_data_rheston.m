...
%% Define model
model = rHestonClass('H',0.1,'rho',-0.5,'nu',0.4);
...
[H_settings,nu_settings,rho_settings,xi_settings] = deal(struct);
...
samplingSettings = {H_settings,nu_settings,rho_settings,xi_settings};
